...
class TestSourceEndpointCRUD:
    ...
    def test_list_sources_endpoint(self, api_available):
    ...
    def test_get_source_endpoint(self, api_available):
    ...
    def test_create_source_endpoint(self, api_available):
    ...
    def test_update_source_endpoint(self, api_available):
    ...
    def test_delete_source_endpoint(self, api_available):
